...
from app.store.database.modles import AnswerModel, QuestionModel, ThemeModel
...
question_data = [
    ...
    {"theme_id": 5, "price": 200, "question_text": "Как называется фильм про космическую станцию с Джорджем Клуни?"},
    {
        "theme_id": 5,
        "price": 300,
        "question_text": "Как называется фильм, где главный герой застрял на необитаемом острове?",
    },
]
...
answer_data = [
    ...
    {"question_id": 1, "answers": {"1917": True, "1918": False, "1919": False, "1920": False}},
    {
        "question_id": 2,
        "answers": {
            "Первая мировая война": True,
            "Вторая мировая война": False,
            "Третья мировая война": False,
            "Четвертая мировая война": False,
        },
    },
    {
        "question_id": 3,
        "answers": {
            ...
            "Бенjamin Franklin": False,
            "Абрахам Линкольн": False,
            "Томас Эдисон": False,
        },
    },
    ...
    {
        "question_id": 5,
        "answers": {"Карл Маркс": True, "Фридрих Энгельс": False, "Владимир Ленин": False, "Иосиф Сталин": False},
    },
    ...
    {
        "question_id": 14,
        "answers": {"Исаак Ньютон": True, "Альберт Эйнштейн": False, "Никола Тесла": False, "Галилео Галилей": False},
    },
    ...
    {
        "question_id": 21,
        "answers": {"Гольф-мяч": True, "Теннисный мяч": False, "Баскетбольный мяч": False, "Футбольный мяч": False},
    },
    ...
    {
        "question_id": 27,
        "answers": {"Парк Юрского периода": True, "Динозавры": False, "Мир динозавров": False, "Затерянный мир": False},
    },
        ...
        async with self.app.database.session() as session:
            try:
                ...
                for answer in answer_data:
                    ...
                    stmt = (
                        insert(AnswerModel)
                        .values(question_id=real_question_id, answers=formatted_answers)
